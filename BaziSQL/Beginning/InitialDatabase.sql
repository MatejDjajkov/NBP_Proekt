CREATE TABLE Administrator (
  ...
  AppUserID       int4 NOT NULL UNIQUE,
...
CREATE TABLE SoloMusician (
  SoloMusicianID SERIAL NOT NULL,
  MusicianID     int4 NOT NULL,
...
ALTER TABLE Musician_MusicGroup ADD CONSTRAINT FKMusician_M109284 FOREIGN KEY (MusicGroupID) REFERENCES MusicGroup (MusicGroupID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE Musician_MusicGroup ADD CONSTRAINT FKMusician_M853110 FOREIGN KEY (MusicianID) REFERENCES Musician (MusicianID) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE TicketOwnerHistory ADD CONSTRAINT FKTicketOwne653324 FOREIGN KEY (TicketID) REFERENCES Ticket (TicketID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE TicketOwnerHistory ADD CONSTRAINT FKTicketOwne745306 FOREIGN KEY (ConsumerID) REFERENCES Consumer (ConsumerID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE SoloMusician_Concert ADD CONSTRAINT FKSoloMusici917899 FOREIGN KEY (ConcertID) REFERENCES Concert (ConcertID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE SoloMusician_Concert ADD CONSTRAINT FKSoloMusici618171 FOREIGN KEY (SoloMusicianID) REFERENCES SoloMusician (SoloMusicianID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE MusicGroup_Concert ADD CONSTRAINT FKMusicGroup28142 FOREIGN KEY (ConcertID) REFERENCES Concert (ConcertID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE MusicGroup_Concert ADD CONSTRAINT FKMusicGroup413064 FOREIGN KEY (MusicGroupID) REFERENCES MusicGroup (MusicGroupID) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE Administrator ADD CONSTRAINT FKAdministra884375 FOREIGN KEY (AppUserID) REFERENCES AppUser (UserID) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE Employee ADD CONSTRAINT FKEmployee501215 FOREIGN KEY (AppUserID) REFERENCES AppUser (UserID) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE Consumer ADD CONSTRAINT FKConsumer742712 FOREIGN KEY (AppUserID) REFERENCES AppUser (UserID) ON DELETE SET NULL ON UPDATE CASCADE;
